      ...
      <div className="div01 divvid2">
        <div className="divcha17 dch17">
          <div className="divcha18">
            <img
              src="https://uzswlu.uz/backend/web/uploads/page/icon/16710165994514.jpg"
              alt=""
              className="rasm13"
            />
            <a
          ...
          <div className="divcha18">
            ...
            <a
              ...
              className="h131"
            >
              Universitet hududidan tashqarida o'tkazilgan tadbirlar
            </a>
          </div>
          <div className="divcha18">
            <img
            ...
            <a
              ...
              className="h131"
            >
              Universitetda ta'lim sifatini yaxshilashga qaratilgan loyihalar
            </a>
          </div>
        </div>
        <Slayder/>
