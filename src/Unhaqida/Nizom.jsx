...
function Nizom() {
  ...
  const fileUrl =
    "/src/img/16862016212227.pdf";
  const filename = "Nizom.pdf";

  return (
    <div className="kattadiv">
      <div className="div1 divvid2 div001">
        <div className="divcha12">
          ...
          />
          <a
            href="https://uzswlu.uz/backend/web/uploads/pagepdf/icon/16862016212227.pdf"
            className="h131"
          >
            Universitet nizomi
          </a>
