  ...
  return (
    <div className="kattadiv">
      <div className="div01">
        ...
        <div className="divcha14">
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/17107560741649.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Creator Admin</h1>
            <h1 className="h135">WEB DEVELOPER</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/17107526041605.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Saida Sultanova Nuriddinovna</h1>
            <h1 className="h135">HEAD OF DEPARTMENT, SENIOUR TEACHER</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/16681452074250.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Roza Timanova Valerevna </h1>
            <h1 className="h135">HEAD OF DEPARTMENT, EFL TEACHER</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/16679964470318.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Ravshan Saidov Tursunovich</h1>
            <h1 className="h135">HEAD OF DEPARTMENT, SENIOR TEACHER</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/16680733113991.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Mukhlisa Djuraeva Shadiyarovna</h1>
            <h1 className="h135">
              HEAD OF THE DEPARTMENT OF ENGLISH FUNCTIONAL LEXICON, ENGLISH
              TEACHER
            </h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/17116996688755.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Layloxon Tolibjonovna Axmedova</h1>
            <h1 className="h135">PROFESSOR OF UZSWLU</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/16680133658235.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Normuratova Valentina Ivanovna</h1>
            <h1 className="h135">FOREIGN LANGUAGE TEACHER (ENGLISH, GERMAN)</h1>
          </div>
          <div className="kichikdiv8">
            <img
              src="https://uzswlu.uz/frontend/web/uploads/user/16682563399125.jpg"
              alt=""
              className="rasm16"
            />
            <h1 className="h134">Dilafruz Kurbanova Shukhratovana</h1>
            <h1 className="h135">ENGLISH TEACHER</h1>
          </div>
        </div>
      </div>
      <div className="div7">
